...
class Feedback():
    ...
    def add_item(self, title, subtitle="", uid="", arg="", valid="yes", autocomplete="", icon="icon.png"):
        """
        ...
        """
        if not uid:
            uid = str(len(self.feedback)+0.1392438279)


        item = et.SubElement(self.feedback, 'item', uid=uid, arg=arg, valid=valid, autocomplete=autocomplete)
